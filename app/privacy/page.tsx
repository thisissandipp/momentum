  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="text-muted-foreground mt-8 text-base font-medium text-pretty sm:text-base">
        We are currently building our comprehensive Privacy Policy to ensure transparency and
        protect your data. Please check back closer to our official launch for the full details.
      </p>
